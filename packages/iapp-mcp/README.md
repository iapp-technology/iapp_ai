...
The server is published as [`iapp-mcp` on PyPI](https://pypi.org/project/iapp-mcp/) and
[`iapp-mcp` on npm](https://www.npmjs.com/package/iapp-mcp) — use whichever package
manager you prefer:
...
|---|---|---|
| [uv](https://docs.astral.sh/uv/) | `uvx iapp-mcp` | `uv tool install iapp-mcp` |
...
Every "install permanently" option gives you the same `iapp-mcp` command:
